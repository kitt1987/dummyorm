...
exports.loadSteps = function(database, cb) {
	...
	if (typeof database === 'string') {
		stepChain = _loadStepChains.bind(this)(database);
		dbName = path.basename(database);
	} else {
		stepChain = _.map(database, _loadStepChains.bind(this));
		dbName = _.reduce(database, function(total, db) {
