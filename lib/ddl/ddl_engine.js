...
exports.ddlTable = '_ormcache_ddl';
...
function _updateSyncStep(step, cb) {
	var up = 'UPDATE ' + exports.ddlTable + ' SET ' + exports.stepColumn +
		'=' + step + ';';
...
function _checkDDLTable(cb) {
	var ddlCreation = 'CREATE TABLE IF NOT EXISTS ' +
		exports.ddlTable + '(id INT PRIMARY KEY AUTO_INCREMENT, ' + exports.stepColumn +
...
function _findSyncStep(cb) {
	var queryStep = 'SELECT ' + exports.stepColumn + ' FROM ' + exports.ddlTable + ';';
	this.engine.performSQL(queryStep, function(err, result) {
		...
		this.engine.performSQL('INSERT INTO ' + exports.ddlTable +
