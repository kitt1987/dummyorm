...
function Record(schema, props) {
  ...
  var $_$ = {};
  props.forEach((prop) => Object.assign($_$, prop));
    ...
    if (v !== null) {
      if (column.type === datatype.ForeignKey) {
        ...
        if (column.type.js === 'boolean') {
          ...
          throw new Error('Value of ' + schema.tableName + ':' + column.name +
...
exports.prototype.getPending = function() {
  var pending = {};
  Object.keys(this).forIn((v, k) => {
    if (k === 'schema' || typeof this[k] === 'function') return;
    if (v === undefined) return;
