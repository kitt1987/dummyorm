...
exports = module.exports = function(options) {
	...
	if (options.privacy) {
		...
		if (!options.privacy.connectionLimit || options.privacy.connectionLimit < 2) {
			throw new Error('Supporting transaction needs 2 connection at least!');
		}
