...
exports.useMemcached = function(properties) {
	if (this.cache)
		throw new Error('Cache has defined');

	this.cache = new MemCached(properties);
};

exports.useRedis = function(properties) {
	if (this.cache)
		throw new Error('Cache has defined');
...
exports.useMysql = function(properties, cb) {
	...
	this.storage.connect(function(err) {
		...
		StepLoader.bind(this)(this.storage, this.options.tag);
