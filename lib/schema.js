...
exports = module.exports = function(tableName, properties, storageEngine) {
	if (!tableName)
		throw Error('You should set table name');

	this.tableName = tableName;
	this.pending = {};
	_createTable.bind(this)(tableName, u.toArray(properties), storageEngine);
};
