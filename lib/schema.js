...
exports = module.exports = function(tableName, properties) {
	...
	this.pending = {};
	_createTable.bind(this)(tableName, properties);
}
...
function _createTable(tableName, columns) {
	var createPending = this.pending['create'] || {};
	createPending.table = this.tableName;
	createPending.column = columns;
	_.map(createPending.column, _defineColumn.bind(this));
}
...
exports.prototype.addColumn = function(columnProperties) {
	...
	_defineColumn.bind(this)(columnProperties);
}
